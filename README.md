# Bootcamp DIO e Unimed BH - Geracao Tech Data Science
...
- Nível: Básico
- Data de Conclusão: 04/10/22
- [X] Introdução ao Git e ao GitHub
- Carga horária: 5 horas
- Nível: Básico
- Data de Conclusão: 31/08/22
...
- Nível: Avançado
- Data de Conclusão: 25/09/22
- Observações: Concluído enquanto realização do Bootcamp "Database Experience"
...
- Nível: Intermediário
- Data de Conclusão:
- [ ] Desconplicando a criação de pacotes de processamento de imagens em Python
- Nível: Avançado
- Data de Conclusão:
